...
echo '-------------------------------------'
echo '               Test A'
echo ' Baseline: latest hexo with meta_generator disabled'
echo '-------------------------------------'
...
echo '-------------------------------------'
echo '               Test B'
echo ' latest hexo with meta_generator enabled'
echo '-------------------------------------'
...
npm uninstall hexo --save
npm install git+https://github.com/sukkaw/hexo.git#meta-generator

echo '-------------------------------------'
echo '               Test C'
echo ' Use sukkaw:meta-generator with meta_generator enabled'
echo '-------------------------------------'
